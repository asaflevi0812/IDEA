...
#define CONTAINER_META_SIZE_NO_FP (20)
...
struct containerWriteRequest {
	bool should_write_only_meta;
	struct container* c;
};
...
void write_container_meta_no_fp(struct container*);
void write_container_async(struct containerWriteRequest*);
...
int container_request_check_id(struct containerWriteRequest*, containerid*);
